...
public class UpdatePassword {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("New password set for User Account with objid='"
					+ userAccountId + "'");
	 ...
	 */
	private static void updatePassword(final String userAccountId,
			final String password) throws TransportException,
